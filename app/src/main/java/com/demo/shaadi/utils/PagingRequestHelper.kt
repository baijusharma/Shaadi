...
import com.demo.shaadi.utils.PagingRequestHelper.Request.Callback
import java.util.*
...
class PagingRequestHelper(retryService: Executor) {
    ...
    val mListeners: CopyOnWriteArrayList<Listener> = CopyOnWriteArrayList()
    ...
    @AnyThread
    @VisibleForTesting
    fun recordResult(wrapper: RequestWrapper, @Nullable throwable: Throwable?) {
        var report: StatusReport? = null
    ...
    fun interface Request {
        ...
        class Callback internal constructor(
            ...
            private val mCalled: AtomicBoolean = AtomicBoolean()
